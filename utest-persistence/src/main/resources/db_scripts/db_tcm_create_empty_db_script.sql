...
insert into RolePermission (rolePermissionId, permissionId, accessRoleId, createdBy, createDate, lastChangedBy, lastChangeDate) values (33, 33, 1, 1, '2010-11-24 20:24:33', 1, '2010-11-24 20:24:33');
DROP TABLE IF EXISTS  SignInFact;
CREATE TABLE SignInFact ( id INT NOT NULL AUTO_INCREMENT, userId INT NOT NULL, impersonatedUserId INT, startDate TIMESTAMP DEFAULT CURRENT_TIMESTAMP, endDate TIMESTAMP NULL, sessionId VARCHAR(255) NOT NULL, ipAddress VARCHAR(255), countryCode VARCHAR(2), city VARCHAR(255), latitude VARCHAR(255), longitude VARCHAR(255), PRIMARY KEY (id), INDEX FK_SignInFact_User (userId), INDEX FK_SignInFact_ImpersonatedUser (impersonatedUserId), INDEX IDX_SESSION_ID (sessionId, startDate) ) ENGINE=InnoDB DEFAULT CHARSET=utf8;
DROP TABLE IF EXISTS  TestCase;
CREATE TABLE TestCase ( testCaseId INT NOT NULL AUTO_INCREMENT, productId INT NOT NULL, maxAttachmentSizeInMBytes INT DEFAULT '10' NOT NULL, maxNumberOfAttachments INT DEFAULT '3' NOT NULL, testCycleId INT COMMENT 'Indicates if during specific Test Cycle.', PRIMARY KEY (testCaseId) ) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Test Cases defined for a specific Product.';
