...
public class TestSuite extends TimelineEntity implements ProductDependable, EnvironmentDependable, Named
{
	...
	public TestSuite(final Integer productId, final String name, final Integer testSuiteStatusId, final boolean useLatestVersions, final Integer createdBy, final Date createDate,
			final Integer lastChangedBy, final Date lastChangeDate)
	{
	...
	public TestSuite(final Integer productId, final String name, final String description, final Integer testSuiteStatusId, final Integer environmentProfileId,
			final boolean useLatestVersions, final Integer createdBy, final Date createDate, final Integer lastChangedBy, final Date lastChangeDate)
	{
		super(createdBy, createDate, lastChangedBy, lastChangeDate);
