...
public class TestRunTestCase extends TimelineEntity implements EnvironmentDependable, TestCaseContainerDependable
{
	...
	public TestRunTestCase(final Integer testRunId, final Integer testCaseVersionId, final Integer testCaseId, final Integer priorityId, final Integer runOrder,
			final boolean blocking, final boolean selfAssignAllowed, final Integer selfAssignLimit, final boolean selfAssignPerEnvironment, final Integer createdBy,
			final Date createDate, final Integer lastChangedBy, final Date lastChangeDate)
	{
	...
	public TestRunTestCase(final Integer testRunId, final Integer testCaseVersionId, final Integer testCaseId, final Integer priorityId, final Integer runOrder,
			...
			final Integer testSuiteId, final Integer createdBy, final Date createDate, final Integer lastChangedBy, final Date lastChangeDate)
	{
		super(createdBy, createDate, lastChangedBy, lastChangeDate);
		this.testRunId = testRunId;
		this.testCaseVersionId = testCaseVersionId;
