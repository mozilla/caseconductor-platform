 ...
 */
public class TestCaseVersion extends TimelineEntity implements EnvironmentDependable, Named, Versioned
{
	...
	public TestCaseVersion(final Integer testCaseId, final String name, final Integer testCaseStatusId, final String description, final Integer majorVersion,
			final Integer minorVersion, final boolean latestVersion, final Integer approvalStatusId, final Integer createdBy, final Date createDate, final Integer lastChangedBy,
	...
	public TestCaseVersion(final Integer testCaseId, final String name, final Integer testCaseStatusId, final String description, final Integer majorVersion,
			final Integer minorVersion, final boolean latestVersion, final Integer approvalStatusId, final Integer approvedBy, final Date approveDate,
			final Integer environmentProfileId, final Integer createdBy, final Date createDate, final Integer lastChangedBy, final Date lastChangeDate)
	{
		super(createdBy, createDate, lastChangedBy, lastChangeDate);
		this.testCaseId = testCaseId;
		this.name = name;
