...
public interface EnvironmentService
{
	...
	UtestSearchResult findEnvironmentGroups(UtestSearch search_, List<Integer> includedEnvironmentId_) throws Exception;
	...
	List<EnvironmentGroup> getEnvironmentGroupsForProfile(Integer environmentProfileId_, List<Integer> includedEnvironmentId_) throws Exception;
	...
	UtestSearchResult findEnvironmentGroupsExploded(UtestSearch search, List<Integer> includedEnvironmentId_) throws Exception;
	...
	List<EnvironmentGroupExploded> getEnvironmentGroupsForProfileExploded(Integer environmentProfileId, List<Integer> includedEnvironmentId_) throws Exception;

	List<Integer> getProfilesContainingEnvironments(List<Integer> environmentIds) throws Exception;
